  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <motion.div
        ...
        className="absolute -left-52 top-20 h-[520px] w-[520px] rounded-full bg-cyan-500/20 blur-[150px]"
      />
      ...
      <motion.div
        ...
        className="absolute -right-52 top-10 h-[520px] w-[520px] rounded-full bg-violet-500/20 blur-[160px]"
      />
      ...
      {/* Bottom Fade */}
      <div className="absolute bottom-0 left-0 h-48 w-full bg-gradient-to-t from-[#07111F] via-[#07111F]/80 to-transparent" />
